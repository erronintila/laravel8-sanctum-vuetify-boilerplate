...
var render = function() {
  ...
  return _c("div", [
    _c("p", { staticClass: "title" }, [_vm._v("Profile")]),
    _vm._v(" "),
    _c("div", { staticClass: "my-4" }, [
      _c("p", [_vm._v("Name: " + _vm._s(_vm.user ? _vm.user.name : ""))]),
      _vm._v(" "),
      _c("p", [_vm._v("Email: " + _vm._s(_vm.user ? _vm.user.email : ""))]),
      _vm._v(" "),
      _c("p", [
        _vm._v("Date Created: " + _vm._s(_vm.user ? _vm.user.created_at : ""))
      ])
    ])
  ])
}
